...
class BoxesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create box" do
    assert_difference('Box.count') do
      post boxes_url, params: { box: { content: @box.content, name: @box.name, price: @box.price, tagname: @box.tagname } }
    end
  ...
  test "should update box" do
    patch box_url(@box), params: { box: { content: @box.content, name: @box.name, price: @box.price, tagname: @box.tagname } }
